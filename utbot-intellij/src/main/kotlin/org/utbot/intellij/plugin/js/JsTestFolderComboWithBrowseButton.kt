...
class JsTestFolderComboWithBrowseButton(private val model: JsTestsModel): ComboboxWithBrowseButton() {
    ...
    private fun createNewTestSourceRoot(model: JsTestsModel): VirtualFile? =
    ...
    private fun formatUrl(virtualFile: VirtualFile, model: JsTestsModel): String {
